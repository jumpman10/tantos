...
export const ResultRecluter = ({navigation, route}: Props) => {
  const {
    points,
    assist,
    rebound,
    ...
    <Scroll>
      ...
      <View style={styles.container}>
        ...
        {fieldGoalPer >= 0 && fieldGoalPer < 11 && (
          <Block
            text="- Bajo porcentaje de tiro(TC)"
            size={17}
            fs="italic"
            ta="left"
            weigth="300"
        ...
        {fieldGoalPer >= 30 && fieldGoalPer < 36 && (
          <Block
            text="- Buen porcentaje de tiro(TC)"
            size={17}
            fs="italic"
            ta="left"
            weigth="300"
        ...
        {fieldGoalPer >= 47 && fieldGoalPer < 70 && (
          <Block
            text="- Excelente porcentaje de tiro(TC)"
            size={17}
            fs="italic"
            ta="left"
            weigth="300"
        ...
        {fieldGoalPer === 100 && (
          <Block
            text="- Porcentaje de tiro(TC) perfecto"
            size={17}
            fs="italic"
            ta="left"
            weigth="300"
        ...
        {freeTPer >= 0 && freeTPer < 11 && (
          <Block
            text="- Mal porcentaje de tiros libres(TL)"
            size={17}
            fs="italic"
            ta="left"
            weigth="300"
        ...
        {freeTPer >= 11 && freeTPer < 29 && (
          <Block
            text="- Bajo porcentaje de tiros libres(TL)"
            size={17}
            fs="italic"
            ta="left"
            weigth="300"
        ...
        {freeTPer >= 36 && freeTPer < 47 && (
          <Block
            text="- Porcentaje de tiros libres(TL)"
            size={17}
            fs="italic"
            ta="left"
            weigth="300"
        ...
        {freeTPer >= 70 && freeTPer < 100 && (
          <Block
            text="- Buen porcentaje de tiros libres(TL)"
            size={17}
            fs="italic"
            ta="left"
            weigth="300"
        ...
        {freeTPer === 100 && (
          <Block
            text="- Porcentaje de tiros libres(TL) perfecto"
            size={17}
            fs="italic"
            ta="left"
            weigth="300"
        ...
        {triplePer >= 0 && triplePer < 11 && (
          <Block
            text="- Bajo porcentaje de triple(T3)"
            size={17}
            fs="italic"
            ta="left"
            weigth="300"
        ...
        {triplePer >= 30 && triplePer < 36 && (
          <Block
            text="- Buen porcentaje de triple(T3)"
            size={17}
            fs="italic"
            ta="left"
            weigth="300"
        ...
        {triplePer >= 47 && triplePer < 70 && (
          <Block
            text="- Excelente porcentaje de triple(T3)"
            size={17}
            fs="italic"
            ta="left"
            weigth="300"
        ...
        {triplePer === 100 && (
          <Block
            text="- Porcentaje de triple(T3) perfecto"
            size={17}
            fs="italic"
            ta="left"
            weigth="300"
